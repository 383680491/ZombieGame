...
function JoyStick:ctor()
    ...
    self.bg:loadTexture("res/mainui/joystick.png")
    self.bg:setScale(1.8)
    self.ball = ccui.ImageView:create()
    self.ball:loadTexture("res/mainui/joystick_bg.png")

    self.ballRadius = 49     --旋转球半径
    self.moveAreaRadius = 88  --旋转球活动半径
    ...
    self.isTouch = false
    self.isUpdate = false
    self:setHitAreaWithRect(cc.rect(0, 0, 1920, 1080))
...
function JoyStick:onEnter()
    ...
    self:scheduleUpdateWithPriorityLua( frameEvent, 0.1 )
end
