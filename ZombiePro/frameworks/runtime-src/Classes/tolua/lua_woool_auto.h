...
int lua_woool_NodeAStar_createPath(lua_State* tolua_S)
{
	int argc = 0;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_woool_NodeAStar_createPath'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_woool_NodeAStar_createPath'", nullptr);
			return 0;
		}
		cobj->createPath();
		lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_woool_NodeAStar_createPath'.", &tolua_err);
#endif

	return 0;
}
int lua_woool_NodeAStar_findPath(lua_State* tolua_S)
{
	int argc = 0;
	NodeAStar* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_woool_NodeAStar_findPath'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_woool_NodeAStar_findPath'", nullptr);
			return 0;
		}
		cobj->findPath(arg0);
		lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_woool_NodeAStar_findPath'.", &tolua_err);
#endif

	return 0;
}
int lua_woool_NodeAStar_deleteDoneNode(lua_State* tolua_S)
{
	int argc = 0;
	NodeAStar* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_woool_NodeAStar_deleteDoneNode'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_woool_NodeAStar_deleteDoneNode'", nullptr);
			return 0;
		}
		cobj->deleteDoneNode();
		lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_woool_NodeAStar_deleteDoneNode'.", &tolua_err);
#endif

	return 0;
}
int lua_woool_NodeAStar_getPathNode(lua_State* tolua_S)
{
	int argc = 0;
	NodeAStar* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_woool_NodeAStar_getPathNode'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_woool_NodeAStar_getPathNode'", nullptr);
			return 0;
		}
...
int lua_woool_NodeAStar_setMap(lua_State* tolua_S)
{
	int argc = 0;
	NodeAStar* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_woool_NodeAStar_setMap'", nullptr);
		return 0;
	}
#endif
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_woool_NodeAStar_setMap'.", &tolua_err);
#endif

	return 0;
}
int lua_woool_NodeAStar_create(lua_State* tolua_S)
{
	int argc = 0;
	bool ok = true;
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_woool_NodeAStar_create'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_woool_NodeAStar_create'.", &tolua_err);
#endif
	return 0;
}
...
int lua_register_woool_NodeAStar(lua_State* tolua_S)
{
	...
	tolua_function(tolua_S, "createPath", lua_woool_NodeAStar_createPath);
	tolua_function(tolua_S, "findPath", lua_woool_NodeAStar_findPath);
	tolua_function(tolua_S, "getPathNode", lua_woool_NodeAStar_getPathNode);
...
TOLUA_API int register_all_woool(lua_State* tolua_S)
{
	...
	lua_register_woool_NodeAStar(tolua_S);
